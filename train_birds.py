...
def main(args: Namespace):
    ...
    for lambda_ in lambdas:
        for init_g in init_gains:
            args.init_gain = init_g
            args.lambda_z = lambda_
            args.n_iterations = 4000
            args.session_name = 'Session_' + str(args.init_gain) + '_' + str(args.lambda_z)
            os.mkdir('Images/' + str(args.session_name))
            print('Gain: ', args.init_gain)
            print('Lz: ', args.lambda_z)
            print('Session: ', args.session_name)
